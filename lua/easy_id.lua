...
local function init(env)
   is_split_sentence = env.engine.schema.config:get_bool('easy_id/split_sentence')
   ...
   local use_wordninja_rs_lua_module = env.engine.schema.config:get_bool('easy_id/use_wordninja_rs_lua_module')
   local use_wordninja_rs = env.engine.schema.config:get_bool('easy_id/use_wordninja_rs')
   local use_wordninja_py = env.engine.schema.config:get_bool('easy_id/use_wordninja_py')
   ...
   if use_wordninja_rs_lua_module then
      local wordninja_rs_lua_module_path = env.engine.schema.config:get_string('easy_id/wordninja_rs_lua_module_path')
   ...
   if use_wordninja_rs then
      local wordninja_rs_path = env.engine.schema.config:get_string('easy_id/wordninja_rs_path')
      wordninja_split = function(sentence)
